...
function resolveTopPageNavTitle(vm) {
  ...
  const staticTitleKeyByRoute = {
    ...
    'pages/profile/model-settings': 'agent_model_assign_nav',
    'pages/profile/staff-api-models': 'agent_model_assign_nav',
    'pages/profile/agent-model-assign': 'agent_model_assign_nav',
